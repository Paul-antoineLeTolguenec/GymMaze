...
class CMaze(Maze):
	...
	def __init__(self, xinit=5, yinit=5, xgoal=90, ygoal=90,width=100,height=100, time_horizon=3000, filename=None, n_beams=5):
	...
	def state_open_cv(self):
		...
		color = (0, 0, 0)
		thickness = -1
		img= cv2.circle(img, center, 6, color, thickness)
